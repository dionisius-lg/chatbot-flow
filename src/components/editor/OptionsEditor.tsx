        ...
        <div className='border-t border-gray-200 pt-2 mt-2'>
            ...
            <div className='flex items-center justify-between mb-2'>
                ...
                <button
                    ...
                    disabled={isBusy}
                    className='text-[10px] bg-blue-500 text-white px-2 py-0.5 rounded hover:bg-blue-600 disabled:opacity-50 cursor-pointer'
                >
                    + Add
                </button>
            </div>
                ...
                <div className='mb-2 p-2 bg-blue-50 rounded border border-blue-200 space-y-1.5'>
                    ...
                    <div className='flex gap-1'>
                        <button
                            ...
                            disabled={isBusy}
                            className='flex-1 text-[10px] border border-gray-300 rounded py-1 hover:bg-gray-50 disabled:opacity-50 cursor-pointer'
                        >
                            Cancel
                        </button>
                        <button
                            ...
                            className='flex-1 text-[10px] bg-blue-500 text-white rounded py-1 hover:bg-blue-600 disabled:opacity-50 cursor-pointer inline-flex items-center justify-center gap-1'
                        >
                            {savingAction === 'add' ? (
                                <>
                            ...
                            <div className='space-y-1'>
                                ...
                                <div className='flex gap-1'>
                                    <button
                                        ...
                                        className='flex-1 text-[10px] border border-gray-300 rounded py-1 hover:bg-gray-50 cursor-pointer disabled:opacity-50'
                                        disabled={isBusy}
                                    >
                                        Cancel
                                    </button>
                                    <button
                                        ...
                                        disabled={isBusy}
                                        className='flex-1 text-[10px] bg-indigo-600 text-white rounded py-1 hover:bg-indigo-700 disabled:opacity-50 cursor-pointer inline-flex items-center justify-center gap-1'
                                    >
                                        {savingAction === 'edit' ? (
                                            <>
                                                <svg className='animate-spin h-3 w-3' viewBox='0 0 24 24'>
                            ...
                            <div className='flex items-center justify-between'>
                                ...
                                <div className='flex gap-1 shrink-0 ml-1'>
                                    <button
                                        ...
                                        disabled={isBusy}
                                        className='text-[10px] text-gray-500 hover:text-indigo-600 px-1 cursor-pointer disabled:opacity-50'
                                    >
                                        {'\u270E'}
                                    </button>
                                    <button
                                        ...
                                        disabled={isBusy}
                                        className='text-[10px] text-gray-500 hover:text-red-600 px-1 cursor-pointer disabled:opacity-50'
                                    >
                                        X
                                    </button>
                                </div>

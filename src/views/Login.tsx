...
import { isValidIpOrDomain } from '../lib/value';
...
export default function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!isValidIpOrDomain(serverInput)) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-2xl p-6 space-y-5">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1.5">IP / Domain Server</label>
            <input
              type="text"
              value={ipServer}
